...
# ==========================================
# 應用程式：MetaVoice (SaaS Beta 4.9 - Header 對齊修復版)
# ==========================================
...
# ------------------------------------------
    ...
    # 1. 頂部 Header：對齊修正 (7:3)
    # 使用 vertical_alignment="bottom" 讓標題與右邊按鈕底部切齊
