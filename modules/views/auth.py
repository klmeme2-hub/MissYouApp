    ...
    with col2:
        ...
        with st.container():
            ...
            <div style="margin-top: 20px; font-size: 12px; color: #666; text-align: center;">
                點擊登入即代表您同意 <a href="#" style="color:#888;">服務條款</a> 與 <a href="#" style="color:#888;">隱私權政策</a>
                <br>© 2026 EchoSoul. All rights reserved.
            </div>
